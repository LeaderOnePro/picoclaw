...
var modelProviderOptionsByName = map[string]ModelProviderOption{
	"openai": {
		...
		SupportsFetch:       true,
		Priority:            100,
		CommonModels:        []string{"gpt-5.6-terra", "gpt-5.6-luna", "gpt-5.6-sol"},
		Aliases:             []string{"gpt"},
		httpAPI:             true,
	},
	"anthropic": {
		...
		DefaultModelAllowed: true,
		Priority:            95,
		CommonModels:        []string{"claude-fable-5", "claude-opus-4-8", "claude-sonnet-5", "claude-haiku-4-5"},
	...
	"gemini": {
		...
		DefaultModelAllowed: true,
		Priority:            90,
		CommonModels:        []string{"gemini-3.1-pro-preview", "gemini-3.5-flash", "gemini-3.1-flash-lite"},
	...
	"qwen-portal": {
		...
		SupportsFetch:       true,
		Priority:            75,
		CommonModels:        []string{"qwen3.7-max", "qwen3.7-plus", "qwen3.6-flash"},
		Aliases:             []string{"qwen"},
		httpAPI:             true,
	},
	"qwen-intl": {
	...
	"zhipu": {
		...
		SupportsFetch:       true,
		Priority:            68,
		CommonModels:        []string{"glm-5.2", "glm-4.5-air", "glm-4.7-flash"},
		Aliases:             []string{"glm"},
		httpAPI:             true,
	},
	"groq": {
	...
	"alibaba-coding": {
		...
		DefaultModelAllowed: true,
		Priority:            36.5,
		CommonModels:        []string{"qwen3.7-plus", "kimi-k3", "glm-5.2", "MiniMax-M3"},
